...
import gui.OrderFrameController;
...
public class ClientUI extends Application {
    ...
    private void OkAction(ActionEvent event) throws IOException {
		...
		loader = new FXMLLoader(getClass().getResource("/gui/OrderFrame.fxml"));
		Pane root = loader.load();
        Scene scene = new Scene(root);
        scene.getStylesheets().add(getClass().getResource("/gui/OrderFrame.css").toExternalForm());
